...
#define __HARDWARE_CONFIG__USER_TIMER_ENABLE__              1       // 启用user_timer.h    
    ...
    #define __HARDWARE_CONFIG__USER_TIMER4_ENABLE__             1       // 启用timer4.h    //? 通用定时器Timer4(16位)
    ...
    #define __HARDWARE_CONFIG__USER_TIMER17_ENABLE__            0       // 启用timer17.h   //? 基本定时器Timer17(16位)
        ...
        #define __HARDWARE_CONFIG__TIMER3_INT_UPDATE_ENABLE__       1       // 启用timer3更新中断 // adc实时示波器显示
        #define __HARDWARE_CONFIG__TIMER4_INT_UPDATE_ENABLE__       1       // 启用timer4更新中断 // 定时填入adc采样数据
        #define __HARDWARE_CONFIG__TIMER5_INT_UPDATE_ENABLE__       0       // 启用timer5更新中断 
...
//? 用户测试文件
#define __HARDWARE_CONFIG__USER_TEST_ENABLE__                       1       // 启用user_test.h  
