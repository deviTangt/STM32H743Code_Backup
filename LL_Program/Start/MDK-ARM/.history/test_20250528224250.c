  while (1){
    ...
    if (TIM2CH1_CAPTURE_STA == 3){
      ...
      printf_s(15, "ÖÜÆÚ:%2d.%03ds %03dus", TIM2CH1_CAPTURE_Period / 1000000, TIM2CH1_CAPTURE_Period / 1000 % 1000, TIM2CH1_CAPTURE_Period % 1000);
      printf_s(16, "ÆµÂÊ:%.3fHz", 1000000.0 / TIM2CH1_CAPTURE_Period);
      printf_s(17, "ÕýÕ¼¿Õ±È:%2d.%03d%%", TIM2CH1_CAPTURE_DutyPeriod * 100 / TIM2CH1_CAPTURE_Period, TIM2CH1_CAPTURE_DutyPeriod * 100000 / TIM2CH1_CAPTURE_Period % 1000);
      printf_s(18, "¸ºÕ¼¿Õ±È:%2d.%03d%%", (TIM2CH1_CAPTURE_Period - TIM2CH1_CAPTURE_DutyPeriod) * 100 / TIM2CH1_CAPTURE_Period, (TIM2CH1_CAPTURE_Period - TIM2CH1_CAPTURE_DutyPeriod) * 100000 / TIM2CH1_CAPTURE_Period % 1000);
    }

    if (RX_tick > Rx_tick_pre + 100){
        Rx_tick_pre = RX_tick;
        /* ï¿½ï¿½Ö¾ï¿½ï¿½Ó¡ï¿½Õµï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ */ 
