...
driverIO SDIO0 = 	{AD_SD0_GPIO_Port, 	AD_SD0_Pin};
driverIO SDIO1 = 	{AD_SD1_GPIO_Port, 	AD_SD1_Pin};
driverIO SDIO2 = 	{AD_SD2_GPIO_Port, 	AD_SD2_Pin};
driverIO SDIO3 = 	{AD_SD3_GPIO_Port, 	AD_SD3_Pin};
driverIO PDC = 		{AD_PDC_GPIO_Port, 	AD_PDC_Pin};
driverIO RST = 		{AD_RST_GPIO_Port, 	AD_RST_Pin};
driverIO SCLK = 	{AD_SCK_GPIO_Port, 	AD_SCK_Pin};
driverIO CS = 		{AD_CSB_GPIO_Port, 	AD_CSB_Pin};
driverIO UPDATE = 	{AD_IUP_GPIO_Port, 	AD_IUP_Pin};
driverIO PS0 = 		{AD_P0_GPIO_Port, 	AD_P0_Pin};
driverIO PS1 = 		{AD_P1_GPIO_Port, 	AD_P1_Pin};
driverIO PS2 = 		{AD_P2_GPIO_Port, 	AD_P2_Pin};
driverIO PS3 = 		{AD_P3_GPIO_Port, 	AD_P3_Pin};
...
void AD9959_error(void)
{
    ...
    while (i > 0)
    {
        //HAL_GPIO_TogglePin(AD_LED_GPIO_Port,AD_LED_Pin);
...
void ReadData_AD9959(uint8_t RegisterAddress, uint8_t NumberofRegisters, uint8_t *RegisterData)
{
    ...
    GPIO_InitStruct.Pin = AD_SD0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(AD_SD0_GPIO_Port, &GPIO_InitStruct);
    delay_9959(0x20);
    // Read data
    // 每个字节的数据都是从高位开始传输
    // 第一个传输的字节是最高位的字节
...
//
//    //写入初始频率
//    ad9959_write_frequency(AD9959_CHANNEL_0, 2000000);
...
//
//    ad9959_write_phase(AD9959_CHANNEL_0, 90);
