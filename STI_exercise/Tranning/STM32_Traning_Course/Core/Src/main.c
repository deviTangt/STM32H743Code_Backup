...
//Pi:3.1415926 自己定义
  ...
  uint32_t set_freq = 2000;
  uint32_t set_duty = 73;
  __HAL_TIM_SetAutoreload(&htim2, 1000000 / set_freq - 1);
  __HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_1, set_duty * 1000000 / 100 / (set_freq - 1));    //修改比较值，修改占空比
