...
#define W_SCL_L 	(HAL_GPIO_WritePin(FPGA_SCL_GPIO_Port, FPGA_SCL_Pin, GPIO_PIN_RESET))
#define W_SCL_H 	(HAL_GPIO_WritePin(FPGA_SCL_GPIO_Port, FPGA_SCL_Pin, GPIO_PIN_SET))
#define W_MO(STATE) (HAL_GPIO_WritePin(FPGA_MOSI_GPIO_Port, FPGA_MOSI_Pin, STATE))
#define R_MI 		(HAL_GPIO_ReadPin(FPGA_MISO_GPIO_Port, FPGA_MISO_Pin))
//s
