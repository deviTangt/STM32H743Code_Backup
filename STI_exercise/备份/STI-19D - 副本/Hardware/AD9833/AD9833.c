...
//***************************	
	...
	#define FSY0_0()	HAL_GPIO_WritePin(AD9833_SYNC_GPIO_Port, 	AD9833_SYNC_Pin,GPIO_PIN_RESET)
	#define FSY0_1()	HAL_GPIO_WritePin(AD9833_SYNC_GPIO_Port,	AD9833_SYNC_Pin,GPIO_PIN_SET)

	#define SCK_0()		HAL_GPIO_WritePin(AD9833_CLK_GPIO_Port, 	AD9833_CLK_Pin,GPIO_PIN_RESET)
	#define SCK_1()		HAL_GPIO_WritePin(AD9833_CLK_GPIO_Port,	 	AD9833_CLK_Pin,GPIO_PIN_SET)

	#define DAT_0()		HAL_GPIO_WritePin(AD9833_DATA_GPIO_Port, 	AD9833_DATA_Pin,GPIO_PIN_RESET)
	#define DAT_1()		HAL_GPIO_WritePin(AD9833_DATA_GPIO_Port, 	AD9833_DATA_Pin,GPIO_PIN_SET)
